...
def make_optimizer(model, extractor, optimizer_config):
    ...
    optim_groups = [
        ...
        {"params": extractor.parameters(), "weight_decay": 0.0, "lr":optimizer_config["ext_learning_rate"]},
    ]
        ...
        with torch.no_grad():
            ...
            for vid_idx in range(num_vids):
                if output[vid_idx]['segments'].shape[0] > 0:
                    ...
                    m = output[vid_idx]['segments'].shape[0]
                    print(output[vid_idx]['video_id'], m)
                    actiondict = {
                        0:  "BaseballPitch",
                        1:  "BasketballDunk",
                        2:  "Billiards",
